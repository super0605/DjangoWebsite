...
class ProfileForm extends Component {
  ...
  renderSelectField = ({ input, label, disabled, meta: { touched, error } }) => {
    return (
      <div className={`field ${touched && error ? "error" : ""}`}>
        <label>{label}</label>
        <select {...input} className="ui selection dropdown" disabled={disabled}>
          <option></option>
...
ProfileForm = connect(mapStateToProps, { register, getUser })(ProfileForm);
